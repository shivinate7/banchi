#!/usr/bin/env python3
"""The supervisor's build job, proved against a throwaway tree (D137).
...
def main() -> int:
    print("supervisor self-test — the build job, against a throwaway tree (D137)")
    ...
    if failures:
        ...
        for line in failures:
            print(f"       {line}")
        return 1
    print(f"{PASS}  the supervisor builds, swaps and refuses as D137 says it does")
    return 0
