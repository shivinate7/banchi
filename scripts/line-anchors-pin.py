...
and `git diff scripts/line-anchors.json` is the receipt, the same discipline
`scripts/ste-ratchet-pin.py` and `scripts/typed-interpunct-pin.mjs` already keep for their
own ratchets (D226, D218).
