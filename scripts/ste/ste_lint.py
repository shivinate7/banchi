...
# per the license's one condition. THE RULES BELOW ARE NOT EDITED — this header is the only
# addition. Re-vendor by re-copying both files and updating this date; do not hand-patch.
