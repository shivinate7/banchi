...
class Catalog:
    ...
    def __init__(
        ...
        *,
        ...
        #
        # TWO COUNTS, BECAUSE THEY ARE TWO DIFFERENT FACTS AND ONE OF THEM USED TO LIE (D135).
        ...
        # dropped", and after D135 that sentence would have covered 8,077 Riftbound rows and
    ...
    def from_export(cls, export: tcgcsv.Export, game: str) -> "Catalog":
        ...
        AND THEN NARROWED TO THE CONDITIONS THIS PRODUCT SELLS (D135) — the game's own Near
        ...
        # D135 — THE THIRD AXIS, AND IT IS A SCOPE RATHER THAN A PARTITION.
        #
