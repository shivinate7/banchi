...
BOTH HALVES ARE NOW FALSE OF THIS MODULE OUTRIGHT (D62). `POST /pipeline/runs/<name>/export`
...
#
# THE LAST MANUAL STEP IN `runs -> join`, AND WHAT REMOVING IT COSTS (D62). `identify` spawns
...
def _coverage(fetched, baseline, finishes: set) -> dict:
    ...
    difference is the whole reason D62 exists as an entry rather than as a function. An
