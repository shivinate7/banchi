...
def get(name: str) -> str:
    ...
    READ ONCE PER PROCESS, which is right for everything that was in this file before D62: an
...
def get_live(name: str) -> str:
    ...
    `get` CANNOT SEE A REPLACED VALUE, AND THAT MADE A REFUSAL'S OWN REMEDY NOT WORK (D62).
