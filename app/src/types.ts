...
/** WHAT THE FETCH ASKED TCGPLAYER FOR, AND WHICH OF THE THREE VOICES CHOSE IT (D75).
 *
 *  `widened` is the D65 field and still says the same thing `scope === 'category'` says; what
 *  D75 adds beside it is WHY, because "the whole category" was never the interesting half. A
