 ...
 * run over several boxes would force one reading and one `decisions.json` across drawers
 * that deserve their own. What is a cart is the REQUEST; a run is unchanged.
 *
