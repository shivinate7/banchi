 ...
 *
 * `fetched` names files this run already holds, put there by `fetchExport` (D62). A name
 ...
 * (D62). Free: it spends nothing, and `POST /pipeline/identify` is still the only route that
