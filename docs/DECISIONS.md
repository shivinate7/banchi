...
marketplace to a person, and a normalised value written back is a value the operator cannot
correct.
...
out of a commit (`store/files.py`'s code ledger) and not a licence to accumulate somebody's
