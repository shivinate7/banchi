...
**Settled 2026-09-09, on the owner's instruction to take `docs/DEBTS.md` §7.** That section had
...
- **The floor is on painted SIZE, and the crop only makes the card bigger in the same box.**
  `docs/DEBTS.md` §7 already records that a floor on size cannot see whether the
