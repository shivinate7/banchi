...
D132 records the owner's interview. Three questions were asked afterwards and answered with a
...
**A port is part of the origin, and D132 did not say so.** Two things are keyed by origin in
...
D132 defers a promoted snapshot until a second person needs the app. If that day comes, the
