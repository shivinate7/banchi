    ...
    },
    {
        ...
        "modules": {
            ...
            "join.py": {"does": "catalog join by SKU, aggregation, bidirectional unmatched reporting",
                        "governed_by": ["D2", "D4", "D7", "D9", "D10", "D11", "D16", "D20", "D21", "D23", "D24", "D25", "D29", "D30", "D35", "D36", "D41", "D49", "D54", "D55", "D56", "D58", "D59", "D67", "D68", "D69"], "tested_by": ["T3"]},            # Rung 0 (a human's answer) sits above the ladder and is applied by join.py, so
    ...
    },
    {
        ...
        "modules": {
            "master.py": {"does": "inventory.json — cards, positions, SKUs, listing states, and "
                          ...
                          "governed_by": ["D3", "D7", "D8", "D10", "D11", "D20", "D21", "D23", "D26", "D34", "D58", "D59"], "tested_by": ["T7"]},
    ...
    },
    {
        ...
        "modules": {
            ...
            "capture_server.py": {
                ...
                # its letter.
                "governed_by": ["D1", "D3", "D4", "D5", "D6", "D7", "D8", "D9", "D10", "D11", "D12", "D13", "D16", "D20", "D21", "D22", "D23", "D24", "D26", "D28", "D29", "D30", "D33", "D34", "D37", "D41", "D43", "D46", "D49", "D52", "D53", "D55", "D56", "D58", "D62", "D64", "D65", "D67"],
                "tested_by": ["T7"],
            },
            "tcg_export.py": {
    ...
    },
    {
        ...
        "modules": {
            ...
            "src/server.ts": {"does": "the only module that talks to the capture server, so the "
                              ...
                              "governed_by": ["D3", "D4", "D5", "D6", "D7", "D8", "D10", "D13", "D19", "D21", "D22", "D23", "D24", "D26", "D28", "D29", "D30", "D32", "D33", "D34", "D37", "D43", "D46", "D48", "D52", "D53", "D58", "D64", "D65", "D68"]},
            "src/types.ts": {"does": "the shapes the server speaks, in the server's own field "
                             ...
                             "governed_by": ["D3", "D4", "D6", "D7", "D8", "D9", "D10", "D11", "D16", "D20", "D21", "D22", "D23", "D24", "D26", "D28", "D29", "D30", "D32", "D33", "D34", "D36", "D37", "D46", "D48", "D49", "D52", "D53", "D56", "D58", "D59", "D62", "D64", "D65", "D67"]},
            ...
            "src/PositionLabel.tsx": {
                "does": "ONE rendering of `pipeline/join.py:Position.label` for every OWNER site "
                        ...
                        "A STATE RATHER THAN A NUMBER IS RANKED TOO (D69): `... \u00b7 departed "
                ...
                "governed_by": ["D10", "D20", "D24", "D30", "D31", "D41", "D58", "D68", "D69"]},
            "src/PositionLabel.css": {
                "does": "the shape, and one knob per site. `--pos-slot` is the only number a site "
                        ...
                        "CARRY A LABEL WITH NO FIGURE (D69): in a list the reserve holds the whole "
                        ...
                        "label's textContent.",
                "governed_by": ["D24", "D31", "D41", "D58", "D68", "D69"]},
            ...
            "src/Inventory.tsx": {
                ...
                "governed_by": ["D5", "D6", "D7", "D8", "D10", "D13", "D24", "D26", "D27", "D31",
                                "D33", "D38", "D39", "D41", "D45", "D57", "D58", "D68", "D69"],
            },
            "src/Inventory.css": {
                "does": "its layout, at the dense owner-side end of the one system, two "
                        ...
                        "OF `PositionLabel`'s SEVEN SITE RULES (D69): `.inventory-lone-place` "
                ...
                "governed_by": ["D5", "D6", "D7", "D13", "D26", "D31", "D41", "D57", "D69"],
            },
            "src/BoxOps.tsx": {
                ...
                "note": "TWO CONTROLS SAY WHAT THEY WILL DO BEFORE THEY DO IT, and both "
                        ...
                        "off the wire.",
                "governed_by": ["D5", "D10", "D13", "D20", "D21", "D22", "D26", "D27", "D31", "D33", "D34", "D36", "D38", "D41", "D58"],
            },
            "src/BoxOps.css": {
            ...
            "tests/inventory.spec.ts": {
                ...
                "governed_by": ["D5", "D7", "D8", "D9", "D10", "D13", "D20", "D22", "D23", "D24", "D26", "D28", "D30", "D31", "D33", "D34", "D37", "D38", "D40", "D41", "D45", "D49", "D55", "D57", "D58", "D67", "D68", "D69"],
