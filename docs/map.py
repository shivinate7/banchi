            ...
            "pipeline_routes.py": {
                "does": "the pipeline seam: POST /pipeline/preflight (free, creates no run), "
                    ...
                    "still outlives this one), "
                        ...
                        "IS THE STANDING UNSENT-COPIES WORKLIST (D-unsent-copies-worklist): "
    ...
    },
    {
        ...
        "modules": {
            ...
            "src/Home.tsx": {"does": "`#/`: the product drawn as a picture. A hero deck of the "
                             ...
                             "governed_by": ["D-unsent-copies-worklist", "D145", "D56", "D5", "D6", "D10", "D13", "D32", "D33", "D52", "D63", "D69", "D86", "D89", "D94", "D95", "D125"]},
            ...
            "src/types.ts": {"does": "the shapes the server speaks, in the server's own field "
                             ...
                             "governed_by": ["D-unsent-copies-worklist", "D145", "D3", "D4", "D6", "D7", "D8", "D9", "D10", "D11",
            ...
            "src/Pricing.tsx": {"does": "#/pricing: the hand-pricing worklist. One row per SKU a "
                                        ...
                                        "COPY IN THE STORE (D-unsent-copies-worklist): the "
                                ...
                                "governed_by": ["D-unsent-copies-worklist", "D4", "D5", "D7", "D9", "D22", "D26", "D28", "D36",
            ...
            "tests/pricing.spec.ts": {"does": "the pricing screen, asserted where nothing else "
                                      ...
                                      "governed_by": ["D-unsent-copies-worklist", "D8", "D9", "D20", "D28", "D33", "D48", "D49", "D51", "D54", "D56", "D57", "D58", "D59", "D62", "D68", "D78", "D79", "D85", "D86", "D98", "D99", "D115", "D117"]},
