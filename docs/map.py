        ...
        "modules": {
            ...
            "screen-freshness.mjs": {
                ...
                "governed_by": ["D13", "D14", "D18", "D28", "D58", "D62", "D76", "D79", "D83",
                                ...
                                "D193", "D203", "D210", "D225", "D227", "D236", "D252", "D273",
                                "D-set-view"],
            },
        ...
        "modules": {
            ...
            "pipeline_routes.py": {
                ...
                "governed_by": ["D1", "D2", "D3", "D8", "D9", "D12", "D13", "D16", "D19", "D20",
                                ...
                                "D216", "D219", "D225", "D227", "D236", "D258", "D-set-view"],
                "tested_by": ["T7"],
            },
            "shipping_routes.py": {
    ...
    },
    {
        ...
        "modules": {
            ...
            "src/kit/index.tsx": {"does": "the primitives as components: Button, IconButton, Kbd, "
                                          ...
                                          "control (ICONOGRAPHY, D288): a required "
            ...
            "governed_by": ["D6", "D8", "D9", "D10", "D16", "D19", "D20", "D21", "D22", "D23",
                            ...
                            "D181", "D192", "D213", "D218", "D221", "D252", "D259", "D263", "D275",
                            "D285", "D-set-view"]},
            ...
            "tests/kit-data.spec.ts": {
                ...
                "governed_by": ["D118", "D195", "D212", "D218", "D221", "D288"],
            },
            ...
            "tests/inventory-sets.spec.ts": {
                "does": "THE OWNER'S \"BY SET\" VIEW (D-set-view), in a browser. The grouping "
                        ...
                        "path.",
                "governed_by": ["D-set-view", "D172", "D201", "D285"],
            },
