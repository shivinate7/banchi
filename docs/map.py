        ...
        "modules": {
            ...
            "kit-adoption.mjs": {
                "does": "`make kit-adoption` — does every screen inherit the page scaffold "
                        ...
                        "with one reader.",
                "governed_by": ["D18", "D173", "D-page-scaffold", "D-ratchets-become-offender-lists", "D-icon-buttons"]},
            "checks.py": {
        ...
        "modules": {
            ...
            "src/kit.css": {"does": "every primitive's look, one `bn-` prefix, loaded after base.css "
                            ...
                            "governed_by": ["D5", "D13", "D26", "D32", "D41", "D50", "D94", "D117",
                                            ...
                                            "D-icon-buttons", "D-notice-detail", "D-one-page-width"]},
            ...
            "src/kit/Page.tsx": {"does": "the page scaffold every screen is built from: `Page` draws "
                                         ...
                                         "the verdict, the toolbar, the status slot, and the list "
                                         "region with its loading and empty states. One width, one "
                                 ...
                                 "governed_by": ["D94", "D118", "D197", "D-icon-buttons",
                                                 "D-one-page-width"]},
            ...
            "tests/kit-data.spec.ts": {
                ...
                "governed_by": ["D118", "D195", "D212", "D218", "D221", "D-icon-buttons"],
            },
            ...
            "tests/icon-button.spec.ts": {
                "does": "`IconButton`, the round-2 findings kept as browser assertions, each "
                        "case observed red on the review's own measurements first: the 40px hit "
                        "area reaching past the visual face (a real click, not just the pseudo's "
                        "geometry); the tooltip on hover and keyboard focus, and dismissed by a "
                        "click; showing it moving nothing else (D118); the overlay Close tooltip "
                        "not clipped by the sheet, at 1440 and 390; the tooltip staying inside "
                        "the viewport at 390; a long-press opening the tooltip without also "
                        "pressing the button; and the toast dismiss glyph's 4.5:1 contrast in "
                        "both themes. Run by `make design-check`.",
                "governed_by": ["D118", "D-icon-buttons"],
            },
            "tests/match.spec.ts": {
            ...
            "tests/filters.spec.ts": {
                ...
                "governed_by": ["D118", "D132", "D-icon-buttons", "D-one-filter-control",
                                "D-view-state-in-url"],
            },
            ...
            "tests/fulfillment.spec.ts": {
                ...
                "governed_by": ["D5", "D10", "D13", "D21", "D24", "D31", "D41", "D93", "D115",
                                ...
                                "D-a-box-is-shown-by-its-name", "D-icon-buttons"],
