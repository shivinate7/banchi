...
COMPONENTS = [
    {
        ...
        "modules": {
            ...
            "cmd_join.py": {"does": "resolve identifications against the export; --dry-run previews, "
                                    ...
                                    "were kept.",
                            "governed_by": ["D3", "D7", "D8", "D11", "D16", "D25", "D36", "D49", "D50"], "tested_by": ["T4", "T7"]},
            "cmd_emit.py": {"does": "write import CSVs; refuses while a price is unanswered. Prices "
                                    ...
                                    "A RE-EMIT ADDS AND NEVER SUBTRACTS (D50): it never opens an "
                                    ...
                                    "somebody thought of.",
                            "governed_by": ["D9", "D25", "D49", "D50"], "tested_by": ["T7"]},
            "cmd_reconcile.py": {"does": "diff intent against TCGplayer's Export From Staged", "governed_by": ["D7", "D8", "D11", "D50"], "tested_by": ["T7"]},
            ...
            "runs.py": {"does": "run directories and manifest.json", "governed_by": ["D1", "D25", "D49", "D50"], "tested_by": ["T7"]},
        },
    },
    {
        "path": "pipeline/",
        ...
        "modules": {
            ...
            "join.py": {"does": "catalog join by SKU, aggregation, bidirectional unmatched reporting",
                        "governed_by": ["D2", "D4", "D7", "D9", "D10", "D11", "D16", "D20", "D21", "D23", "D24", "D25", "D29", "D35", "D49", "D50"], "tested_by": ["T3"]},
    ...
    },
    {
        ...
        "modules": {
            ...
            "pipeline_routes.py": {
                ...
                "governed_by": ["D1", "D2", "D3", "D9", "D13", "D16", "D21", "D25", "D29", "D32", "D48", "D50"],
                "tested_by": ["T7"],
            },
        },
    },
    {
        ...
        "modules": {
            ...
            "src/RunFiles.tsx": {"does": "a run's files, as downloads — extracted from RunPanel on "
                                       "2026-08-30 (D50) so two screens can draw them. The `only` "
            ...
            "src/RunPanel.tsx": {"does": "THE PIPELINE, ON A SCREEN. The four commands of batch "
                                 ...
                                 # max-edge beside it.
                                 "governed_by": ["D1", "D3", "D9", "D13", "D16", "D28", "D31", "D32", "D33", "D39", "D49", "D48", "D50"]},
            ...
            "tests/pricing.spec.ts": {"does": "the pricing screen, asserted where nothing else "
                                              ...
                                              "runs it.",
                                      "governed_by": ["D9", "D28", "D33", "D49", "D50"]},
            "tests/run-panel.spec.ts": {
                ...
                "governed_by": ["D1", "D3", "D9", "D13", "D31", "D32", "D33", "D39", "D48", "D50"],
