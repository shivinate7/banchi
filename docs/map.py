    ...
    },
    {
        ...
        "modules": {
            ...
            "src/Revenue.tsx": {"does": "`#/revenue` (Sales): the gross-revenue "
                                        ...
                                        "SINCE `D-revenue-slice`: every column sorts, the "
            ...
            "src/Revenue.css": {"does": "the verdict, the month strip and the product table's "
                                        ...
                                        "Since `D-revenue-slice`: sortable headers, a "
                                        ...
                                        "shared kit rule.",
                                "governed_by": ["D50", "D94", "D-revenue-slice"]},
            ...
            "tests/revenue.spec.ts": {
                "does": "`#/revenue`'s own suite (`D-revenue-slice`): the empty and failure "
