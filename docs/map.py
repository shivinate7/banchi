...
COMPONENTS = [
    {
        ...
        "modules": {
            ...
            "cmd_join.py": {"does": "resolve identifications against the export; --dry-run previews. "
                            ...
                            "governed_by": ["D3", "D7", "D8", "D9", "D11", "D12", "D16", "D25", "D34", "D36", "D49", "D54", "D58", "D59", "D86", "D87", "D99", "D115", "D135"], "tested_by": ["T4", "T7"]},
    ...
    },
    {
        ...
        "modules": {
            "tcgcsv.py": {"does": "TCGplayer Filtered CSV read/write and byte-format inspection",
                          ...
                          # And D135 added SEALED_CONDITION beside them, plus the correction
                          ...
                          "governed_by": ["D11", "D22", "D25", "D49", "D135"], "tested_by": ["T2"],
            ...
            "join.py": {"does": "catalog join by SKU, aggregation, bidirectional unmatched reporting. "
                                ...
                                "game's own Near Mint strings plus sealed (D135). It had never cut on "
                        ...
                        "governed_by": ["D2", "D3", "D4", "D7", "D9", "D10", "D11", "D12", "D16", "D20", "D21", "D23", "D24", "D25", "D29", "D30", "D35", "D36", "D41", "D49", "D54", "D55", "D56", "D58", "D59", "D64", "D65", "D67", "D68", "D71", "D76", "D87", "D135"], "tested_by": ["T3"]},
    ...
    },
    {
        ...
        "modules": {
            ...
            "src/Home.tsx": {"does": "`#/`: the product drawn as a picture. A hero deck of the "
                             ...
                             "governed_by": ["D5", "D6", "D10", "D13", "D32", "D33", "D52", "D63", "D69", "D86", "D89", "D94", "D95", "D125"]},
