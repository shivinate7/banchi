...
COMPONENTS = [
    {
        ...
        "modules": {
            ...
            "resolve.py": {"does": "turning a run's identifications into a join; shared by join and emit. "
                                   ...
                                   "(D150).",
                           "governed_by": ["D147", "D145", "D4", "D8", "D10", "D11", "D20", "D21", "D22", "D23", "D24", "D25", "D26", "D33", "D34", "D36", "D49", "D56", "D58", "D59", "D64", "D87", "D115", "D150", "D166", "D180", "D-a-join-with-no-run-directory"], "tested_by": ["T7"]},
