        ...
        "modules": {
            ...
            "janitor.py": {
                "does": "the sweep: what a finished session left behind, and — where it is "
                        ...
                        "NO SESSION in it. A BARE RUN PRESSES TIER 1, and janitor.py's own "
                        "header and status.py's both say it presses nothing — OPEN as of "
                        "2026-09-19, recorded in `sweep`'s docstring, the owner's call to "
                        "settle. TIER 2 previews and waits for `--confirm`: a merged branch "
